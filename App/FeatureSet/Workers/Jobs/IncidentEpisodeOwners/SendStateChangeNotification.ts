    ...
    for (const episodeStateTimeline of episodeStateTimelines) {
      ...
      for (const user of owners) {
        ...
        const sms: SMSMessage = {
          message: `This is a message from Cast Operations. Incident Episode ${episodeIdentifier} - state changed${previousState ? ` from ${previousState.name}` : ""} to ${incidentState!
        ...
        const callMessage: CallRequestMessage = {
          data: [
            {
              sayMessage: `This is a message from Cast Operations. Incident Episode ${
                episodeIdentifier
