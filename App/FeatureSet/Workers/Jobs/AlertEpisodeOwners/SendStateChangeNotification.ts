    ...
    for (const episodeStateTimeline of episodeStateTimelines) {
      ...
      for (const user of owners) {
        ...
        const sms: SMSMessage = {
          message: `This is a message from Cast Operations. Alert Episode ${episodeIdentifier} - state changed${previousState ? ` from ${previousState.name}` : ""} to ${alertState!
        ...
        const callMessage: CallRequestMessage = {
          data: [
            {
              sayMessage: `This is a message from Cast Operations. Alert Episode ${
                episodeIdentifier
