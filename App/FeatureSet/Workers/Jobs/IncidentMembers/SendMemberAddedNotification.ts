    ...
    for (const incidentId in incidentMembersMap) {
      ...
      for (const member of members) {
        ...
        const sms: SMSMessage = {
          message: `This is a message from Cast Operations. You have been assigned as ${roleName} to the incident ${incidentIdentifier}. To unsubscribe from this notification go to User Settings in Cast Operations Dashboard.`,
        };

        const callMessage: CallRequestMessage = {
          data: [
            {
              sayMessage: `This is a message from Cast Operations. You have been assigned as ${roleName} to the incident ${incidentIdentifier}. To unsubscribe from this notification go to User Settings in Cast Operations Dashboard. Good bye.`,
            },
          ],
        };
