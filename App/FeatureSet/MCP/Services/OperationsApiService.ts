...
export default class OperationsApiService {
   ...
   */
  public static initialize(config: OperationsApiConfig): void {
    try {
    ...
    MCPLogger.info(
      `Cast Operations API Service initialized with: ${config.url}`,
    );
  }
  ...
  private static buildCreateData(args: OperationsToolCallArgs): JSONObject {
  ...
  private static buildUpdateData(args: OperationsToolCallArgs): JSONObject {
