...
const buildTelegramSetupMarkdown: () => string = (): string => {
  ...
  return [
    ...
    "2. Ask users to open **User Settings → Notification Methods → Telegram** in the Cast Operations dashboard. They'll scan a QR (or tap a deep link) to send `/start <code>` to your bot — that's how we capture their chat ID and mark the account verified.",
      ...
      <CardModelDetail
        ...
        formFields={[
          ...
          },
          {
            ...
            required: false,
            description:
              "Any strong random string. Cast Operations rejects webhook calls whose X-Telegram-Bot-Api-Secret-Token header does not match this value.",
