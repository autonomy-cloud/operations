...
在 Linux 發行版上將 Cast Operations 安裝為桌面應用程式，以進行全面的監控與事件管理。
...
1. **在 Chrome/Chromium 中開啟 Cast Operations**
