...
- Cast Operations 儀表板中的**頂層功能**，位於 **Analytics & Automation → Runbooks** 之下。
...
2. **（選用）新增規則**——在事件、警示或排程維護的設定中，告訴 Cast Operations 只要某事件的標題或描述符合某個正規表示式，就啟動這個 runbook。
...
| 步驟類型         | 在以下情況選用…                                                                                                                                                  | 範例                                                     |
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- |
| **Manual**       | 需要人類去驗證某件事、做出判斷，或採取 Cast Operations 無法觀測到的動作。                                                                                              | 「在負載平衡器儀表板上確認次要區域的流量。」             |
...
## runbook 如何與 Cast Operations 的其餘部分搭配
