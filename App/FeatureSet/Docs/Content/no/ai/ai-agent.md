...
Hvis du selvhoster Cast Operations, endre `CAST_OPERATIONS_URL` til din egendefinerte selvhostede instans-URL.
...
Opprett en `cast-operations-ai-agent.yaml`-fil:
