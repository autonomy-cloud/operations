...
Installer den native iOS-appen **Cast Operations On-Call** fra Apple App Store på din iPhone eller iPad.
...
2. Trykk på **Søk**-fanen og søk etter **«Cast Operations On-Call»**, eller åpne denne lenken på enheten din:
...
4. Når appen er installert, trykk **Åpne** eller start **Cast Operations On-Call** fra startskjermen.
...
1. Gå til **Innstillinger → Varsler → Cast Operations On-Call**.
...
5. Legg til **Cast Operations On-Call** i alle **Fokus**-modi der du fortsatt vil motta tilkallinger.

## Oppdateringer

Appen oppdateres gjennom App Store:

- Åpne **App Store**, trykk på profilbildet ditt, bla til **Cast Operations On-Call** og trykk **Oppdater**.
- Eller aktiver **Innstillinger → App Store → Appoppdateringer** for å installere oppdateringer automatisk.

## Avinstaller

1. **Trykk og hold** på **Cast Operations On-Call**-ikonet på startskjermen.
...
- Appen er publisert i den globale App Store. Hvis den ikke vises i din region, kontakt [brukerstøtten](mailto:support@latticeruntime.com).
...
- Åpne **Innstillinger → Varsler → Cast Operations On-Call** og bekreft at varsler er tillatt.
- Deaktiver **Ikke forstyrr** eller legg Cast Operations On-Call til på tillatelseslisten for den aktive Fokus-modusen.
