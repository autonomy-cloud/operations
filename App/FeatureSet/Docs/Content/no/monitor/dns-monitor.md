...
DNS-overvåking lar deg overvåke helse og korrekthet for DNS-oppslag for dine domener. Cast Operations spør periodisk DNS-poster og validerer svarene mot dine konfigurerte kriterier.
