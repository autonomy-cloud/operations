...
Erstatt `YOUR_SECRET_KEY` med den hemmelige nøkkelen som vises i monitorinnstillingene, og `https://visca.ai` med URL-en til din Cast Operations-instans hvis du selvhoster.
