# Cast Operations को Microsoft Teams से Connect करना

### Cast Operations को Microsoft Teams से Connect करने के Steps

1. **Cast Operations पर Account बनाएं**

   - [Cast Operations.com](https://latticeruntime.com) पर जाएं और account बनाएं।
   - Account बनने के बाद, एक नया project बनाएं।

2. **Microsoft Teams को Cast Operations Project से Connect करें**

   - अपने Cast Operations project में **Project Settings** > **Microsoft Teams** पर जाएं।
   - अपने Microsoft Teams account को Cast Operations project से connect करने के लिए prompts follow करें।
