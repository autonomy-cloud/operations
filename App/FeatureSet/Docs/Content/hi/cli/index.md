...
Cast Operations CLI एक command-line interface है जो आपको terminal से सीधे अपने Cast Operations resources प्रबंधित करने की अनुमति देती है। यह monitors, incidents, alerts, status pages और अधिक पर पूर्ण CRUD operations का समर्थन करती है।

## विशेषताएं

- production, staging और development के लिए named contexts के साथ **Multi-environment support**
- आपके Cast Operations instance से उपलब्ध resources की **Auto-discovery**
