...
1. एक वर्कफ़्लो बनाएँ जो **[Cast Operations event trigger](/docs/workflows/triggers#cast-operations-event-triggers)** से शुरू हो — उदाहरण के लिए **Incident → On Create**।
