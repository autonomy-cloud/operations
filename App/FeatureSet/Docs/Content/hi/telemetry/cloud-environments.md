...
## Cast Operations किसी environment की पहचान कैसे करता है
...
## चरण 2 — Cast Operations को OTLP एक्सपोर्ट करें
...
यदि आप Cast Operations को स्वयं-होस्ट करते हैं, तो `https://YOUR-OPERATIONS-HOST/otlp` का उपयोग करें।
