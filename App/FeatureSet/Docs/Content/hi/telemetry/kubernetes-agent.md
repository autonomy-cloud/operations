...
`YOUR_ONEUPTIME_URL`, `YOUR_ONEUPTIME_API_KEY`, और क्लस्टर नाम को अपने परिवेश के मानों से बदलें। क्लस्टर नाम वह है जिस तरह क्लस्टर Cast Operations में दिखाई देगा — `prod-us-east-1` जैसा कुछ स्थिर चुनें।
