...
वर्कफ़्लो आपको बिना कोड लिखे Cast Operations में कार्यों को स्वचालित करने देते हैं। कैनवास पर कुछ ब्लॉक खींचें और छोड़ें, उन्हें आपस में जोड़ें, और आपके पास ऐसा ऑटोमेशन है जो जब भी कुछ होता है तब चलता है — कोई incident खुलता है, कोई शेड्यूल चालू होता है, या कोई अन्य टूल Cast Operations को डेटा भेजता है।
...
- **Cast Operations को अपने अन्य टूल्स से जोड़ें** — incidents को Slack पर भेजें, Jira टिकट बनाएँ, अपने स्टैक में किसी webhook पर पोस्ट करें।
- **Cast Operations में जो होता है उस पर प्रतिक्रिया दें** — जब कोई गंभीर incident बनाया जाए, तो ऑन-कॉल टीम को सूचित करें और स्वचालित रूप से एक टिकट खोलें।
- **शेड्यूल पर जॉब चलाएँ** — हर पाँच मिनट में, हर रात, हर सोमवार सुबह।
- **बाहर से डेटा प्राप्त करें** — अन्य सिस्टम्स को एक यूनिक URL के माध्यम से Cast Operations में डेटा पुश करने दें।
...
1. **एक ट्रिगर** — जो वर्कफ़्लो शुरू करता है। यह एक मैनुअल बटन, एक शेड्यूल, एक इनकमिंग webhook, या Cast Operations में कोई इवेंट (जैसे कि एक नया incident) हो सकता है।
...
## Cast Operations में वर्कफ़्लो कहाँ खोजें
...
2. **एक ट्रिगर चुनें** — मैनुअल, शेड्यूल्ड, webhook, या Cast Operations से कोई इवेंट।
...
## वर्कफ़्लो Cast Operations के बाकी हिस्से में कैसे फिट होते हैं
