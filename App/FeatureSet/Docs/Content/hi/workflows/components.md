...
Cast Operations के माध्यम से एक ईमेल भेजें।
...
## Cast Operations डेटा कंपोनेंट

Cast Operations में हर प्रकार के रिकॉर्ड के लिए (monitors, incidents, alerts, status pages, on-call policies, और कई अन्य), पैलेट में ये कंपोनेंट होते हैं — टाइप के नाम से सर्च करें:
...
इसी तरह एक वर्कफ़्लो Cast Operations डेटा को पढ़ और बदल सकता है। उदाहरण के लिए: आपके CI टूल से एक webhook विफलता विवरण के साथ एक incident खोलने के लिए **Create Incident** का उपयोग कर सकता है।

## मुझे कौन सा कंपोनेंट इस्तेमाल करना चाहिए?

कुछ त्वरित नियम:

- यदि आप जो चाहते हैं उसके लिए एक समर्पित ब्लॉक है (Slack, Email, एक Cast Operations रिकॉर्ड), तो उसका उपयोग करें — आपको बेहतर त्रुटि हैंडलिंग और स्पष्ट लॉग मिलते हैं।
