...
Bash और JavaScript चरण **Cast Operations Worker पर कभी नहीं चलते**। उन्हें job के रूप में एक विशिष्ट [Runbook एजेंट](/docs/runbooks/agents) पर dispatch किया जाता है — एक छोटी प्रक्रिया जिसे आप अपनी अपनी इन्फ्रास्ट्रक्चर के एक होस्ट पर इंस्टॉल करते हैं।
