...
अपने iPhone या iPad पर Apple App Store से **Cast Operations On-Call** native iOS app install करें।
...
2. **Search** tab पर tap करें और **"Cast Operations On-Call"** search करें, या अपने device पर यह link open करें:
...
4. एक बार install हो जाने पर, **Open** पर tap करें या अपनी home screen से **Cast Operations On-Call** launch करें।
...
1. **Settings → Notifications → Cast Operations On-Call** पर जाएं।
...
5. किसी भी **Focus** mode में **Cast Operations On-Call** add करें जहां आप अभी भी pages प्राप्त करना चाहते हैं।

## Updates

app को App Store के माध्यम से update किया जाता है:

- **App Store** open करें, अपनी profile picture पर tap करें, **Cast Operations On-Call** तक scroll करें, और **Update** पर tap करें।
- या updates automatically install करने के लिए **Settings → App Store → App Updates** enable करें।

## Uninstall

1. अपनी home screen पर **Cast Operations On-Call** icon को **Long-press** करें।
...
- **Settings → Notifications → Cast Operations On-Call** open करें और पुष्टि करें कि notifications allowed हैं।
- **Do Not Disturb** disable करें या Cast Operations On-Call को अपने active Focus mode की allow list में add करें।
