...
व्यापक monitoring और incident management के लिए Cast Operations को Windows पर desktop application के रूप में install करें।
...
2. **App Install करें**
   ...
   - **"Install Cast Operations"** button पर क्लिक करें
...
4. **Installation पूरी करें**
   ...
   - Cast Operations अपनी window में खुलेगा
...
4. **App Launch करें**
   - Windows Start Menu में Cast Operations खोजें
...
1. **Cast Operations को Firefox में खोलें**
...
1. **Auto-Start**: Cast Operations को Windows के साथ start करने के लिए configure करें
   - taskbar पर right-click करें → Task Manager → Startup
   - यदि चाहें तो Cast Operations सक्षम करें
...
1. **Windows Notifications**
   ...
   - Cast Operations खोजें और alert preferences configure करें
   - incidents के लिए banner notifications सक्षम करें

2. **Focus Assist**
   - Do Not Disturb settings configure करें
   - Cast Operations critical notifications की अनुमति दें
...
2. Cast Operations instance से HTTPS connection सत्यापित करें
...
```
Solutions:
1. Windows search में "Cast Operations" खोजें
...
2. Cast Operations के लिए notifications सक्षम करें
3. Focus Assist settings जांचें
4. Cast Operations में notification permissions सुनिश्चित करें
...
3. **Start Menu Method**
   - Start Menu में Cast Operations पर Right-click करें
   - "Uninstall" चुनें
