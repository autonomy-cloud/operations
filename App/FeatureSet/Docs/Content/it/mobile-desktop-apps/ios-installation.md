...
Installa l'app iOS nativa **Cast Operations On-Call** dall'Apple App Store sul tuo iPhone o iPad.
...
2. Tocca la scheda **Cerca** e cerca **"Cast Operations On-Call"**, oppure apri questo link sul tuo dispositivo:
...
4. Una volta installata, tocca **Apri** o avvia **Cast Operations On-Call** dalla schermata Home.

## Primo avvio e accesso

1. **URL del server**
   - Se utilizzi Cast Operations Cloud, lascia il valore predefinito `https://latticeruntime.com`.
...
1. Vai su **Impostazioni → Notifiche → Cast Operations On-Call**.
...
5. Aggiungi **Cast Operations On-Call** a tutte le modalità **Full Immersion** in cui desideri comunque ricevere gli avvisi.

## Aggiornamenti

L'app viene aggiornata tramite l'App Store:

- Apri l'**App Store**, tocca la tua foto profilo, scorri fino a **Cast Operations On-Call** e tocca **Aggiorna**.
- Oppure attiva **Impostazioni → App Store → Aggiornamenti app** per installare gli aggiornamenti automaticamente.

## Disinstallazione

1. **Tieni premuta** l'icona di **Cast Operations On-Call** nella schermata Home.
...
- L'app è pubblicata sull'App Store globale. Se non appare nella tua regione, contatta il [supporto](mailto:support@latticeruntime.com).
...
- Apri **Impostazioni → Notifiche → Cast Operations On-Call** e verifica che le notifiche siano consentite.
- Disattiva **Non disturbare** o aggiungi Cast Operations On-Call all'elenco delle eccezioni della modalità Full Immersion attiva.
