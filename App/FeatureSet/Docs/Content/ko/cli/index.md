...
Cast Operations CLI는 터미널에서 Cast Operations 리소스를 직접 관리하기 위한 명령줄 인터페이스입니다. 모니터, 인시던트, 알림, 상태 페이지 등에 대한 전체 CRUD 작업을 지원합니다.

## 기능

- 프로덕션, 스테이징 및 개발을 위한 명명된 컨텍스트를 통한 **다중 환경 지원**
- Cast Operations 인스턴스에서 사용 가능한 리소스의 **자동 검색**
