...
iPhone 또는 iPad에 Apple App Store에서 **Cast Operations On-Call** 네이티브 iOS 앱을 설치하세요.
...
2. **검색** 탭을 누르고 **"Cast Operations On-Call"**을 검색하거나, 기기에서 다음 링크를 엽니다:
...
4. 설치가 완료되면 **열기**를 누르거나 홈 화면에서 **Cast Operations On-Call**을 실행합니다.
...
1. **설정 → 알림 → Cast Operations On-Call**로 이동합니다.
...
5. 호출을 계속 받고 싶은 **집중 모드(Focus)**에 **Cast Operations On-Call**을 추가하세요.

## 업데이트

앱은 App Store를 통해 업데이트됩니다:

- **App Store**를 열고 프로필 사진을 누른 다음 **Cast Operations On-Call**까지 스크롤하여 **업데이트**를 누릅니다.
- 또는 **설정 → App Store → 앱 업데이트**를 활성화하여 업데이트를 자동으로 설치합니다.

## 제거

1. 홈 화면에서 **Cast Operations On-Call** 아이콘을 **길게 누릅니다**.
2. **앱 제거 → 앱 삭제**를 누릅니다.
3. **삭제**를 눌러 확인합니다.
...
- **설정 → 알림 → Cast Operations On-Call**을 열고 알림이 허용되어 있는지 확인하세요.
- **방해 금지 모드(Do Not Disturb)**를 비활성화하거나 활성 집중 모드의 허용 목록에 Cast Operations On-Call을 추가하세요.
