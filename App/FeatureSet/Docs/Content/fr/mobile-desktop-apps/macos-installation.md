...
Installez Cast Operations comme application de bureau native sur macOS pour une surveillance et une gestion des incidents transparentes.
...
1. **Ouvrir Cast Operations dans Safari**

   - Lancez le navigateur Safari
   - Accédez à l'URL de votre instance Cast Operations
   - Connectez-vous à votre compte Cast Operations
...
3. **Personnaliser l'installation**
   ...
   - **Nom de l'application** : Modifiez si souhaité (par défaut : Cast Operations)
   - **Dock** : Choisissez d'ajouter au Dock
   - **Launchpad** : Ajoutez au Launchpad pour un accès facile

4. **Lancer l'application**
   - Trouvez Cast Operations dans le Dock, Launchpad ou le dossier Applications
...
1. **Ouvrir Cast Operations dans Chrome**

   - Lancez Google Chrome
   - Accédez à votre instance Cast Operations
...
2. **Installer via le menu**
   ...
   - Cliquez sur **« Installer Cast Operations »**
...
4. **Accéder à l'application**
   - Trouvez Cast Operations dans le dossier Applications
...
1. **Ouvrir Cast Operations dans Edge**

   - Lancez Microsoft Edge
   - Accédez à l'URL Cast Operations
...
1. **Position dans le Dock** : Faites glisser Cast Operations vers la position préférée dans le Dock
...
1. **Centre de notifications**
   ...
   - Préférences système → Notifications → Cast Operations
...
```
Solutions :
1. Vérifiez Launchpad pour l'icône Cast Operations
...
```
Solutions :
1. Préférences système → Notifications → Cast Operations
...
5. Vérifiez les paramètres de notification Cast Operations
...
- La PWA Cast Operations se met à jour automatiquement lorsqu'elle est en ligne
...
- Redémarrez l'application Cast Operations
...
Créez des raccourcis personnalisés pour Cast Operations :

1. Ouvrez l'application **Raccourcis**
2. Créez un **Nouveau raccourci**
3. Ajoutez l'action **« Ouvrir l'application »**
4. Sélectionnez **Cast Operations**
5. Ajoutez à Siri pour l'activation vocale

### Intégration Terminal

Gérez Cast Operations via Terminal :

```bash
# Créer un alias pour lancer Cast Operations rapidement
echo 'alias oneuptime="open -a \"Cast Operations\""' >> ~/.zshrc

# Fonction pour vérifier si Cast Operations est en cours d'exécution
oneuptime_status() {
