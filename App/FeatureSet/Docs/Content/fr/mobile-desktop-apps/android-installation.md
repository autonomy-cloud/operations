...
Installez l'application Android native **Cast Operations On-Call** depuis le Google Play Store, ou installez le fichier APK directement sur les appareils sans Google Play.
...
2. Recherchez **« Cast Operations On-Call »**, ou ouvrez ce lien sur votre appareil :
   [https://github.com/autonomy-cloud/operations/releases](https://github.com/autonomy-cloud/operations/releases)
3. Appuyez sur **Installer**.
4. Une fois l'installation terminée, appuyez sur **Ouvrir** ou lancez **Cast Operations On-Call** depuis votre tiroir d'applications.
...
4. Lancez **Cast Operations On-Call** depuis votre tiroir d'applications.

L'APK est compilé et signé par Cast Operations à partir des mêmes sources que la version du Play Store. Les mises à jour de l'application ne sont pas automatiques lorsque vous installez l'APK manuellement — téléchargez le dernier APK depuis le lien ci-dessus lorsqu'une nouvelle version est publiée.
...
1. Ouvrez **Paramètres → Applications → Cast Operations On-Call → Notifications** et vérifiez que toutes les catégories sont activées.
2. Ouvrez **Paramètres → Applications → Cast Operations On-Call → Batterie** et choisissez **Sans restriction** (ou désactivez l'optimisation de la batterie) afin que le système d'exploitation ne retarde pas les notifications push en arrière-plan.
...
4. Si vous utilisez des appareils Samsung, désactivez également **Paramètres → Maintenance de l'appareil → Batterie → Limites d'utilisation en arrière-plan** pour Cast Operations On-Call.
5. Ajoutez Cast Operations On-Call à toutes les listes d'exceptions de **Do Not Disturb** afin que les notifications continuent à sonner pendant votre garde.

## Mises à jour

**Google Play :**

- Les mises à jour s'installent automatiquement. Pour en déclencher une manuellement, ouvrez **Play Store → Profil → Gérer les applications et l'appareil → Mises à jour disponibles → Cast Operations On-Call → Mettre à jour**.
...
1. **Appuyez longuement** sur l'icône **Cast Operations On-Call**, puis appuyez sur **Désinstaller**.
2. Ou ouvrez **Paramètres → Applications → Cast Operations On-Call → Désinstaller**.
...
- Vérifiez que les notifications sont activées dans **Paramètres → Applications → Cast Operations On-Call → Notifications**.
- Désactivez l'optimisation de la batterie pour Cast Operations On-Call (voir Notifications push ci-dessus).
- Assurez-vous que Do Not Disturb est désactivé, ou que Cast Operations On-Call figure dans la liste des exceptions.
