...
Installez Cast Operations comme application de bureau sur Windows pour une surveillance et une gestion des incidents complètes.
...
2. **Installer l'application**
   ...
   - Cliquez sur le bouton **« Installer Cast Operations »**
...
4. **Terminer l'installation**
   ...
   - Cast Operations s'ouvrira dans sa propre fenêtre
...
4. **Lancer l'application**
   - Trouvez Cast Operations dans le menu Démarrer de Windows
...
1. **Ouvrir Cast Operations dans Firefox**
...
1. **Démarrage automatique** : Configurez Cast Operations pour démarrer avec Windows
   - Clic droit sur la barre des tâches → Gestionnaire des tâches → Démarrage
   - Activez Cast Operations si souhaité
...
1. **Notifications Windows**
   ...
   - Trouvez Cast Operations et configurez les préférences d'alerte
...
2. **Assistance à la concentration**
   ...
   - Autorisez les notifications critiques Cast Operations
...
2. Vérifiez la connexion HTTPS à l'instance Cast Operations
...
```
Solutions :
1. Recherchez « Cast Operations » dans la recherche Windows
...
2. Activez les notifications pour Cast Operations
3. Vérifiez les paramètres Assistance à la concentration
4. Assurez-vous des permissions de notification dans Cast Operations
...
3. **Méthode menu Démarrer**
   - Clic droit sur Cast Operations dans le menu Démarrer
