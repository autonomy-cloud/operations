...
provider "oneuptime" {
  oneuptime_url = "https://operations.votreentreprise.com"  # Votre URL auto-hébergée
...
```hcl
# dev.tfvars
oneuptime_url = "https://operations-dev.votreentreprise.com"
...
```hcl
# staging.tfvars
oneuptime_url = "https://operations-staging.votreentreprise.com"
environment = "staging"
```
