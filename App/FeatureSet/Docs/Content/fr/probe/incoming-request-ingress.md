...
- **`Probe ingress: failed to forward to <url> after N attempts`** — la sonde n'a pas pu atteindre Cast Operations. Vérifiez la connectivité sortante de la sonde, les paramètres de proxy et la valeur de `ONEUPTIME_URL`.
