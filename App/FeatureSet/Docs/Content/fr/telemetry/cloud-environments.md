...
## Comment Cast Operations identifie un environnement
...
## Étape 2 — Exporter OTLP vers Cast Operations
...
Si vous hébergez Cast Operations vous-même, utilisez `https://YOUR-OPERATIONS-HOST/otlp`.
