...
**Si vous auto-hébergez Cast Operations** : Si vous auto-hébergez Cast Operations, vous pouvez remplacer l'`endpoint_url` par l'URL de votre instance Cast Operations. `http(s)://VOTRE_HÔTE_ONEUPTIME/fluentd/logs`
