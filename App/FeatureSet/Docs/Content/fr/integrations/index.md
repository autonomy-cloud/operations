...
1. Créez un workflow qui commence par un **[déclencheur d'événement Cast Operations](/docs/workflows/triggers#cast-operations-event-triggers)** — par exemple **Incident → On Create**.
