...
在 Linux 发行版上将 Cast Operations 安装为桌面应用程序，实现全面的监控和事件管理。
...
1. **在 Chrome/Chromium 中打开 Cast Operations**
