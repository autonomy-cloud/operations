...
- Cast Operations 仪表板 **分析与自动化 → Runbooks** 下的**顶层功能**。
...
2. **（可选）添加规则** — 在事件、告警或计划维护的设置中，让 Cast Operations 在事件标题或描述匹配正则时启动这个 Runbook。
...
| 步骤类型       | 适用场景                                                                                                                                                  | 例子                                                   |
| -------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ |
| **Manual**     | 必须由人来验证、判断或执行 Cast Operations 无法观察的动作。                                                                                                     | "在负载均衡器仪表板上确认副本区域流量。"               |
...
## Runbook 如何与 Cast Operations 的其他部分配合
