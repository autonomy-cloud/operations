...
Cast Operations 移动应用将 Expo Push Token 注册到后端。当后端需要发送通知时，它会 POST 到公共 Expo Push API，该 API 代表应用将消息路由到 Apple APNs 或 Google FCM。
...
- 检查 Cast Operations 服务器日志中的 Expo Push API 错误
