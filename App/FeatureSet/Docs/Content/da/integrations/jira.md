...
Hvis du gemte Jira-nøglen på hændelsen i Trin 4, er matching ligetil. Se [Komponenter → Cast Operations data-komponenter](/docs/workflows/components#oneuptime-data-components).
