...
Installer den native Android-app **Cast Operations On-Call** fra Google Play Store, eller sideload APK'en direkte på enheder uden Google Play.
...
2. Søg efter **"Cast Operations On-Call"**, eller åbn dette link på din enhed:
   [https://github.com/autonomy-cloud/operations/releases](https://github.com/autonomy-cloud/operations/releases)
3. Tryk på **Installer**.
4. Når den er installeret, skal du trykke på **Åbn** eller starte **Cast Operations On-Call** fra din app-skuffe.
...
4. Start **Cast Operations On-Call** fra din app-skuffe.

APK'en er bygget og signeret af Cast Operations fra den samme kildekode som Play Store-udgivelsen. App-opdateringer er ikke automatiske ved sideloading — download den nyeste APK fra linket ovenfor, når en ny version udgives.
...
1. Åbn **Indstillinger → Apps → Cast Operations On-Call → Notifikationer**, og bekræft, at alle kategorier er aktiveret.
2. Åbn **Indstillinger → Apps → Cast Operations On-Call → Batteri**, og vælg **Ubegrænset** (eller deaktiver batterioptimering), så operativsystemet ikke forsinker push-meddelelser i baggrunden.
3. Tillad appen at køre i baggrunden, og deaktiver eventuelle "Datasparer"-begrænsninger for den.
4. Hvis du bruger Samsung-enheder, skal du også slå **Indstillinger → Enhedspleje → Batteri → Grænser for baggrundsforbrug** fra for Cast Operations On-Call.
5. Føj Cast Operations On-Call til alle undtagelseslister for **Do Not Disturb**, så tilkald stadig ringer under din on-call-vagt.

## Opdateringer

**Google Play:**

- Opdateringer installeres automatisk. For at udløse en manuelt skal du åbne **Play Store → Profil → Administrer apps og enhed → Opdateringer tilgængelige → Cast Operations On-Call → Opdater**.
...
1. **Tryk længe** på **Cast Operations On-Call**-ikonet, og tryk derefter på **Afinstaller**.
2. Eller åbn **Indstillinger → Apps → Cast Operations On-Call → Afinstaller**.
...
- Bekræft, at notifikationer er aktiveret under **Indstillinger → Apps → Cast Operations On-Call → Notifikationer**.
- Deaktiver batterioptimering for Cast Operations On-Call (se Push-notifikationer ovenfor).
- Sørg for, at Do Not Disturb er slået fra, eller at Cast Operations On-Call er på undtagelseslisten.
