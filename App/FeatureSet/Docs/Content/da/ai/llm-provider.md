...
Se [Helm chart README](https://github.com/autonomy-cloud/operations/tree/master/HelmChart/Public/cast-operations#local-models-with-vllm) for GPU-scheduling, gated modeller og tuning-muligheder.
