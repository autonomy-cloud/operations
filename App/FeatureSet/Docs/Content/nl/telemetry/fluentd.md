...
**Als u Cast Operations zelf host**: Als u Cast Operations zelf host, kunt u de `endpoint_url` vervangen door de URL van uw Cast Operations-instantie. `http(s)://YOUR_CAST_OPERATIONS_HOST/fluentd/logs`
