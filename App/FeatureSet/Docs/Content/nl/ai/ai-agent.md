...
Als u Cast Operations zelf host, wijzig `ONEUPTIME_URL` naar de URL van uw eigen zelf-gehoste instantie.
...
3. Neem contact op met [ondersteuning](https://visca.ai/support) als u een enterprise-abonnement heeft
