...
O aplicativo móvel do Cast Operations registra um Expo Push Token com o backend. Quando o backend precisa enviar uma notificação, ele faz POST para a API pública do Expo Push, que roteia a mensagem para o Apple APNs ou Google FCM em nome do aplicativo.
...
- Verifique os logs do servidor do Cast Operations para erros da API Expo Push
