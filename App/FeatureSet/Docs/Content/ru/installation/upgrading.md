...
В этом руководстве описывается безопасное обновление самостоятельно размещённой установки Cast Operations.
...
- Копирование можно безопасно выполнять, пока Cast Operations работает. Новая телеметрия независимо пишется в новые таблицы; скопированная история заполняется позади неё.
...
Затем обновитесь и дождитесь полного запуска Cast Operations, прежде чем продолжать.
...
## Обновление с Cast Operations 7 → 8
