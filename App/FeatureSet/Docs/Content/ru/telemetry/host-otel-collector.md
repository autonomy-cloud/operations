...
- **Телеметрия не появляется в Cast Operations**
  ...
  - Убедитесь, что хост может достучаться до `https://visca.ai/otlp` (или вашей самостоятельно размещённой конечной точки): `curl -v https://visca.ai/otlp` с той же машины.
