...
- При использовании visca.ai всегда доступна последняя версия Playwright и браузеров. При самостоятельном хостинге убедитесь, что зонды обновлены до последней версии Playwright и браузеров.
