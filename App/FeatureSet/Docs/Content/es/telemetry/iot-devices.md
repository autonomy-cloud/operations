...
2. Confirma que el endpoint del exportador sea `https://visca.ai/otlp` (o tu `…/otlp` autoalojado) y que el encabezado `x-cast-operations-token` lleve un token válido.
