...
## Cómo identifica Cast Operations un entorno
...
## Paso 2 — Exporta OTLP a Cast Operations
...
Si alojas Cast Operations por tu cuenta, usa `https://YOUR-OPERATIONS-HOST/otlp`.
