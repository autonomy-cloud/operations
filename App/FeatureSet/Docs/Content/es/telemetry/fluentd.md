...
**Si te auto-alojas en Cast Operations**: Si te auto-alojas en Cast Operations, puedes reemplazar el `endpoint_url` con la URL de tu instancia de Cast Operations. `http(s)://YOUR_ONEUPTIME_HOST/fluentd/logs`
