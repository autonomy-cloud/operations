...
Para variables de **Atributo de telemetría**, Cast Operations sabe a qué atributo se asigna la variable y aplica el filtro a cada widget que use el mismo atributo: no tienes que editar cada widget a mano.
