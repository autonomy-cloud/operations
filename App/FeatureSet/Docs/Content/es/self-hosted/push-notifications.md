...
La aplicación móvil de Cast Operations registra un Token Push de Expo con el backend. Cuando el backend necesita enviar una notificación, hace un POST a la API pública de Expo Push, que enruta el mensaje a Apple APNs o Google FCM en nombre de la aplicación.
...
- Comprueba los registros del servidor de Cast Operations para detectar errores de la API de Expo Push
