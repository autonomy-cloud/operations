...
1. Construye un workflow que comience con un **[disparador de evento de Cast Operations](/docs/workflows/triggers#oneuptime-event-triggers)** — por ejemplo **Incident → On Create**.
