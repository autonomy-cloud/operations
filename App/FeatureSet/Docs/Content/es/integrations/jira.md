...
Si guardaste la clave de Jira en el incidente en el Paso 4, la coincidencia es sencilla. Consulta [Componentes → Componentes de datos de Cast Operations](/docs/workflows/components#oneuptime-data-components).
