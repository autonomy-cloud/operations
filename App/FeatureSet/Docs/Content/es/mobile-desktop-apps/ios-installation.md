...
Instale la aplicación nativa de iOS **Cast Operations On-Call** desde la Apple App Store en su iPhone o iPad.
...
2. Toque la pestaña **Buscar** y busque **"Cast Operations On-Call"**, o abra este enlace desde su dispositivo:
...
4. Una vez instalada, toque **Abrir** o inicie **Cast Operations On-Call** desde su pantalla de inicio.
...
1. Vaya a **Ajustes → Notificaciones → Cast Operations On-Call**.
...
5. Añada **Cast Operations On-Call** a cualquier modo de **Concentración** en el que aún desee recibir avisos.

## Actualizaciones

La aplicación se actualiza a través de la App Store:

- Abra la **App Store**, toque su foto de perfil, desplácese hasta **Cast Operations On-Call** y toque **Actualizar**.
- O habilite **Ajustes → App Store → Actualizaciones de apps** para instalar las actualizaciones automáticamente.

## Desinstalación

1. **Mantenga pulsado** el icono de **Cast Operations On-Call** en su pantalla de inicio.
...
- La aplicación se publica en la App Store global. Si no aparece en su región, contacte con [soporte](mailto:support@latticeruntime.com).
...
- Abra **Ajustes → Notificaciones → Cast Operations On-Call** y confirme que las notificaciones estén permitidas.
- Desactive **No molestar** o añada Cast Operations On-Call a la lista de permitidos de su modo de Concentración activo.
