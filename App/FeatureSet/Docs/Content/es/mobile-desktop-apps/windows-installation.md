...
Instala Cast Operations como una aplicación de escritorio en Windows para un monitoreo y gestión de incidentes completos.
...
2. **Instala la aplicación**
   ...
   - Haz clic en el botón **"Instalar Cast Operations"**
...
4. **Completa la instalación**
   ...
   - Cast Operations se abrirá en su propia ventana
...
4. **Inicia la aplicación**
   - Encuentra Cast Operations en el menú Inicio de Windows
...
1. **Abre Cast Operations en Firefox**
...
1. **Inicio automático**: Configura Cast Operations para que inicie con Windows
   - Haz clic derecho en la barra de tareas → Administrador de tareas → Inicio
   - Habilita Cast Operations si lo deseas
...
1. **Notificaciones de Windows**
   ...
   - Busca Cast Operations y configura las preferencias de alerta
   - Habilita notificaciones de banner para incidentes

2. **Asistente de concentración**
   - Configura los ajustes de No molestar
   - Permite las notificaciones críticas de Cast Operations
...
2. Verifica la conexión HTTPS a la instancia de Cast Operations
...
```
Soluciones:
1. Busca "Cast Operations" en la búsqueda de Windows
...
2. Habilita las notificaciones para Cast Operations
3. Comprueba la configuración del Asistente de concentración
4. Asegura los permisos de notificación en Cast Operations
...
3. **Método del menú Inicio**
   - Haz clic derecho en Cast Operations en el menú Inicio
