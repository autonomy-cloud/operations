...
Ersätt `YOUR_ONEUPTIME_URL`, `YOUR_ONEUPTIME_API_KEY` och klusternamnet med värden för din miljö. Klusternamnet är hur klustret kommer att visas i Cast Operations — välj något stabilt som `prod-us-east-1`.
