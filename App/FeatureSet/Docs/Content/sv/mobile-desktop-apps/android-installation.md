...
Installera den inbyggda Android-appen **Cast Operations On-Call** från Google Play Store, eller sidoladda APK:n direkt på enheter utan Google Play.

## Krav

- Android-telefon eller surfplatta som kör **Android 8.0 (Oreo) eller senare**
- Ett aktivt Cast Operations-konto (eller URL:en till din egendrivna Cast Operations-instans)
...
2. Sök efter **"Cast Operations On-Call"**, eller öppna den här länken på din enhet:
...
4. När installationen är klar trycker du på **Öppna** eller startar **Cast Operations On-Call** från applådan.
...
4. Starta **Cast Operations On-Call** från applådan.

APK:n byggs och signeras av Cast Operations från samma källkod som Play Store-versionen. Appuppdateringar sker inte automatiskt vid sidoladdning — ladda ner den senaste APK:n från länken ovan när en ny version släpps.

## Första start och inloggning

1. **Server-URL**
   - Om du använder Cast Operations Cloud, behåll standardvärdet `https://latticeruntime.com`.
   - Om du har egen drift anger du URL:en till din Cast Operations-instans (t.ex. `https://operations.example.com`).
   - Appen verifierar att servern är nåbar innan den fortsätter.
2. **Logga in**
   - Ange e-postadressen och lösenordet för ditt Cast Operations-konto.
...
1. Öppna **Inställningar → Appar → Cast Operations On-Call → Aviseringar** och bekräfta att alla kategorier är aktiverade.
2. Öppna **Inställningar → Appar → Cast Operations On-Call → Batteri** och välj **Obegränsad** (eller inaktivera batterioptimering) så att operativsystemet inte fördröjer push-meddelanden i bakgrunden.
3. Tillåt att appen körs i bakgrunden och inaktivera eventuella "Datasparare"-begränsningar för den.
4. Om du använder Samsung-enheter, stäng även av **Inställningar → Enhetsvård → Batteri → Bakgrundsbegränsningar** för Cast Operations On-Call.
5. Lägg till Cast Operations On-Call i alla undantagslistor för **Stör ej** så att utkallelser fortfarande ringer under ditt jourskift.

## Uppdateringar

**Google Play:**

- Uppdateringar installeras automatiskt. För att utlösa en manuellt, öppna **Play Store → Profil → Hantera appar och enheter → Uppdateringar tillgängliga → Cast Operations On-Call → Uppdatera**.
...
1. **Tryck och håll** på ikonen för **Cast Operations On-Call** och tryck sedan på **Avinstallera**.
2. Eller öppna **Inställningar → Appar → Cast Operations On-Call → Avinstallera**.
3. Bekräfta för att ta bort appen.

Ditt Cast Operations-konto och dina jourscheman lagras på serversidan och tas inte bort när du avinstallerar appen.
...
- Om du befinner dig på ett företagsnätverk eller VPN, säkerställ att Cast Operations-instansen är åtkomlig.
- Bekräfta att servern levereras via HTTPS med ett giltigt certifikat.

**Tar inte emot push-aviseringar:**

- Bekräfta att aviseringar är aktiverade i **Inställningar → Appar → Cast Operations On-Call → Aviseringar**.
- Inaktivera batterioptimering för Cast Operations On-Call (se Push-aviseringar ovan).
- Säkerställ att Stör ej är avstängt, eller att Cast Operations On-Call finns på undantagslistan.
- Logga ut och logga in igen för att uppdatera push-token som är registrerad hos servern.
- Användare med egen drift: bekräfta att push-aviseringar är konfigurerade på din Cast Operations-instans (se guiden [Push-aviseringar](/docs/self-hosted/push-notifications) för egen drift).
...
Om du fortfarande behöver hjälp, kontakta oss via din Cast Operations-instrumentpanel eller skapa ett ärende på vårt [GitHub-arkiv](https://github.com/autonomy-cloud/operations).
