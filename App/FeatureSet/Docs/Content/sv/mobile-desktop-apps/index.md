# Cast Operations mobil- och skrivbordsappar

Cast Operations erbjuder två sätt att använda plattformen utanför webbläsaren:
...
- **Installerbara skrivbordsappar** för Windows, macOS och Linux, levererade som en Progressive Web App (PWA) som installeras direkt från din webbläsare. Dessa ger Cast Operations-instrumentpanelen ett eget fönster, en egen ikon och en egen aviseringsyta på din dator.

## Mobil (inbyggda appar)

Appen **Cast Operations On-Call** är en inbyggd applikation byggd med React Native. Den distribueras via de officiella butikerna så att du får automatiska uppdateringar, push-aviseringar och biometrisk upplåsning.

- **iOS** — [Ladda ner i App Store](https://github.com/autonomy-cloud/operations/releases). Kräver iOS 15.0 eller senare. Se [installationsguiden för iOS](./ios-installation.md).
- **Android** — [Hämta i Google Play](https://github.com/autonomy-cloud/operations/releases). Kräver Android 8.0 eller senare. En direkt [APK-nedladdning](https://github.com/autonomy-cloud/operations/releases/latest/download/cast-operations-on-call-android-app.apk) finns också tillgänglig för enheter utan Google Play. Se [installationsguiden för Android](./android-installation.md).

## Skrivbord (Progressive Web App)

Cast Operations webbinstrumentpanel är en Progressive Web App, så du kan installera den som ett skrivbordsprogram från en modern webbläsare utan att gå via någon butik.
...
1. Öppna din Cast Operations-instans i en Chromium-baserad webbläsare (Chrome, Edge) eller Safari.
...
- Bekräfta att din Cast Operations-instans levereras via HTTPS.
...
- Användare med egen drift: bekräfta att push-aviseringar är konfigurerade på din Cast Operations-instans.
...
- Rapportera buggar eller funktionsönskemål på vårt [GitHub-arkiv](https://github.com/autonomy-cloud/operations).
