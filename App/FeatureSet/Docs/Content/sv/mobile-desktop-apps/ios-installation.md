...
Installera den inbyggda iOS-appen **Cast Operations On-Call** från Apple App Store på din iPhone eller iPad.
...
2. Tryck på fliken **Sök** och sök efter **"Cast Operations On-Call"**, eller öppna den här länken på din enhet:
...
4. När installationen är klar trycker du på **Öppna** eller startar **Cast Operations On-Call** från hemskärmen.
...
1. Gå till **Inställningar → Aviseringar → Cast Operations On-Call**.
...
5. Lägg till **Cast Operations On-Call** i alla **Fokus**-lägen där du fortfarande vill ta emot utkallelser.

## Uppdateringar

Appen uppdateras via App Store:

- Öppna **App Store**, tryck på din profilbild, scrolla till **Cast Operations On-Call** och tryck på **Uppdatera**.
- Eller aktivera **Inställningar → App Store → Appuppdateringar** för att installera uppdateringar automatiskt.

## Avinstallera

1. **Tryck och håll** på ikonen för **Cast Operations On-Call** på hemskärmen.
...
- Appen är publicerad i den globala App Store. Om den inte visas i din region, kontakta [supporten](mailto:support@latticeruntime.com).
...
- Öppna **Inställningar → Aviseringar → Cast Operations On-Call** och bekräfta att aviseringar är tillåtna.
- Inaktivera **Stör ej** eller lägg till Cast Operations On-Call i listan över tillåtna appar för ditt aktiva Fokus-läge.
