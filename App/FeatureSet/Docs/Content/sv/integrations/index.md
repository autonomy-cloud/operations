...
1. Bygg ett arbetsflöde som börjar med en **[Cast Operations-händelseutlösare](/docs/workflows/triggers#oneuptime-event-triggers)** — till exempel **Incident → On Create**.
