...
Die Cast Operations Mobile-App registriert einen Expo Push-Token beim Backend. Wenn das Backend eine Benachrichtigung senden muss, sendet es einen POST-Request an die öffentliche Expo Push API, die die Nachricht im Namen der App an Apple APNs oder Google FCM weiterleitet.
...
- Prüfen Sie Cast Operations-Server-Logs auf Expo Push API-Fehler
