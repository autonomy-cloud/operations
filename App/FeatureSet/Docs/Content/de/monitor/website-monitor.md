...
Der Website-Monitor ermöglicht die Überwachung der Verfügbarkeit, Leistung und Reaktion jeder Website oder Webseite. Cast Operations sendet periodisch HTTP-Anfragen an Ihre Website-URL und prüft, ob sie korrekt antwortet.
...
Standardmäßig folgt Cast Operations HTTP-Weiterleitungen (301, 302 usw.). Aktivieren Sie diese Option, wenn Sie die Weiterleitungsantwort selbst überwachen möchten.
