...
1. Bauen Sie einen Workflow, der mit einem **[Cast Operations-Ereignis-Auslöser](/docs/workflows/triggers#oneuptime-event-triggers)** beginnt – zum Beispiel **Incident → On Create**.
