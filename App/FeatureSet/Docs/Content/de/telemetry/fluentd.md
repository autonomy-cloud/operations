...
**Wenn Sie Cast Operations selbst hosten**: Wenn Sie Cast Operations selbst hosten, können Sie `endpoint_url` durch die URL Ihrer Cast Operations-Instanz ersetzen. `http(s)://YOUR_ONEUPTIME_HOST/fluentd/logs`
