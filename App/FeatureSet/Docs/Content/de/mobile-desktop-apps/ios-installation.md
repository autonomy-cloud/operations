...
Installieren Sie die native iOS-App **Cast Operations On-Call** aus dem Apple App Store auf Ihrem iPhone oder iPad.
...
2. Tippen Sie auf den Tab **Suchen** und suchen Sie nach **„Cast Operations On-Call"**, oder öffnen Sie diesen Link auf Ihrem Gerät:
...
4. Sobald die Installation abgeschlossen ist, tippen Sie auf **Öffnen** oder starten Sie **Cast Operations On-Call** von Ihrem Home-Bildschirm aus.
...
1. Gehen Sie zu **Einstellungen → Mitteilungen → Cast Operations On-Call**.
...
5. Fügen Sie **Cast Operations On-Call** allen **Fokus**-Modi hinzu, in denen Sie weiterhin Benachrichtigungen erhalten möchten.

## Updates

Die App wird über den App Store aktualisiert:

- Öffnen Sie den **App Store**, tippen Sie auf Ihr Profilbild, scrollen Sie zu **Cast Operations On-Call** und tippen Sie auf **Aktualisieren**.
- Oder aktivieren Sie **Einstellungen → App Store → App-Updates**, um Updates automatisch zu installieren.

## Deinstallation

1. **Halten Sie das Symbol von Cast Operations On-Call** auf Ihrem Home-Bildschirm gedrückt.
...
- Die App wird im globalen App Store veröffentlicht. Wenn sie in Ihrer Region nicht erscheint, wenden Sie sich an den [Support](mailto:support@latticeruntime.com).
...
- Öffnen Sie **Einstellungen → Mitteilungen → Cast Operations On-Call** und vergewissern Sie sich, dass Mitteilungen erlaubt sind.
- Deaktivieren Sie **Nicht stören** oder fügen Sie Cast Operations On-Call zur Erlaubnisliste Ihres aktiven Fokus-Modus hinzu.
