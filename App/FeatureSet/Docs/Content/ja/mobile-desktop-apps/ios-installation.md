...
iPhone または iPad に Apple App Store から **Cast Operations On-Call** ネイティブ iOS アプリをインストールします。
...
2. **検索** タブをタップして「**Cast Operations On-Call**」を検索するか、デバイスで次のリンクを開きます:
...
4. インストール完了後、**開く** をタップするか、ホーム画面から **Cast Operations On-Call** を起動します。
...
1. **設定 → 通知 → Cast Operations On-Call** を開きます。
...
5. ページを引き続き受け取りたい **集中モード** には、**Cast Operations On-Call** を追加してください。

## アップデート

アプリは App Store を通じて更新されます:

- **App Store** を開き、プロフィール画像をタップして **Cast Operations On-Call** までスクロールし、**アップデート** をタップします。
- または、**設定 → App Store → App のアップデート** を有効にして、アップデートを自動的にインストールします。

## アンインストール

1. ホーム画面の **Cast Operations On-Call** アイコンを **長押し** します。
...
- **設定 → 通知 → Cast Operations On-Call** を開き、通知が許可されていることを確認してください。
- **おやすみモード** を無効にするか、現在有効な集中モードの許可リストに Cast Operations On-Call を追加してください。
