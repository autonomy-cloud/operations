...
アプリケーションを実行すると、Cast Operationsのテレメトリーサービスページでログを確認できます。ご不明な点がある場合は、support@latticeruntime.com にお問い合わせください。
...
exporters:
  ...
  otlphttp:
    ...
    headers:
      ...
      "x-cast-operations-token": "CAST_OPERATIONS_TOKEN" # Cast Operationsトークン
