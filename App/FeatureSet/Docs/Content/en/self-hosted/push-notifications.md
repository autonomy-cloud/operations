...
The Cast Operations mobile app registers an Expo Push Token with the backend. When the backend needs to send a notification it POSTs to the public Expo Push API, which routes the message to Apple APNs or Google FCM on behalf of the app.
...
- Check Cast Operations server logs for Expo Push API errors
