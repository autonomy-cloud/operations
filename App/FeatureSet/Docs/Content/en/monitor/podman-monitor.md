...
The agent is published as `ghcr.io/autonomy-cloud/operations/podman-agent:release` on Docker Hub. See the [Podman Host installation guide](https://github.com/autonomy-cloud/operations/tree/master/PodmanAgent) for the full `podman run` and Compose examples.
