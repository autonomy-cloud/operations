...
**If you're self hosting Cast Operations**: If you're self hosting Cast Operations you can replace the `endpoint_url` with the URL of your Cast Operations instance. `http(s)://YOUR_ONEUPTIME_HOST/fluentd/logs`
