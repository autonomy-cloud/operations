...
import { getPodmanInstallationMarkdown } from "../../Pages/Podman/Utils/DocumentationMarkdown";
...
const PodmanDocumentationCard: FunctionComponent<ComponentProps> = (
      ...
      return (
        <div className="text-center py-6">
          ...
          <p className="text-xs text-gray-500 mb-4">
            Create an ingestion key to authenticate your Podman agent.
          </p>
          <button
            type="button"
            onClick={() => {
  ...
  const installationMarkdown: string = getPodmanInstallationMarkdown({
    ...
    <div>
      ...
      {showCreateModal && (
        <ModelFormModal<TelemetryIngestionKey>
          ...
          description="Create a new telemetry ingestion key for authenticating your Podman agent."
          onClose={() => {
            ...
            fields: [
              {
                ...
                required: true,
                placeholder: "e.g. Podman Agent Key",
                validation: {
                  minLength: 2,
                },
              },
