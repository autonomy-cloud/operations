...
import { getDockerInstallationMarkdown } from "../../Pages/Docker/Utils/DocumentationMarkdown";
...
const DockerDocumentationCard: FunctionComponent<ComponentProps> = (
      ...
      return (
        <div className="text-center py-6">
          ...
          <p className="text-xs text-gray-500 mb-4">
            Create an ingestion key to authenticate your Docker agent.
          </p>
          <button
            type="button"
            onClick={() => {
  ...
  const installationMarkdown: string = getDockerInstallationMarkdown({
    ...
    <div>
      ...
      {showCreateModal && (
        <ModelFormModal<TelemetryIngestionKey>
          ...
          description="Create a new telemetry ingestion key for authenticating your Docker agent."
          onClose={() => {
            ...
            fields: [
              {
                ...
                required: true,
                placeholder: "e.g. Docker Agent Key",
                validation: {
                  minLength: 2,
                },
              },
