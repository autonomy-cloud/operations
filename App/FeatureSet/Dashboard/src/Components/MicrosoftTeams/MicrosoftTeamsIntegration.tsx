...
const MicrosoftTeamsIntegration: FunctionComponent<ComponentProps> = (
    ...
    if (MicrosoftTeamsAppClientId) {
      ...
      setError(
        <div>
          ...
          environment variables when you installed Cast Operations. For more
  ...
  if (!isUserAccountConnected && isProjectAccountConnected) {
    ...
    cardButtons = [
      ...
      {
        title: `Uninstall Cast Operations from Microsoft Teams`,
        isLoading: isButtonLoading,
        buttonStyle: SharedButtonStyle.DANGER,
        onClick: async () => {
          try {
    ...
    <Fragment>
      <div className="mt-6">
        <Card
          ...
          description={
            isAdminConsentCompleted
              ? "Admin consent has been successfully granted for the Cast Operations Microsoft Teams app. You can now proceed to connect your account."
              : "Grant tenant-wide admin consent for the Cast Operations Microsoft Teams app. This step is required to enable application permissions (e.g., posting to channels) without per-user consent. You must be a Microsoft 365 admin."
          }
          buttons={
            isAdminConsentCompleted
              ? [
...
3. **Install the app:**
   - Find "Cast Operations" in your apps
