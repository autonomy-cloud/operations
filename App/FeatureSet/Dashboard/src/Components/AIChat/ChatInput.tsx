...
const ChatInput: FunctionComponent<ComponentProps> = (
  ...
  return (
    <div className="border-t border-gray-200 bg-white px-4 pb-3 pt-3">
      <div className="rounded-lg border border-gray-200 bg-white px-3 py-2.5 transition-all focus-within:border-gray-300 focus-within:ring-2 focus-within:ring-gray-900/[0.04]">
        {props.contextChip && (
