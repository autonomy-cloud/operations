...
import { getProxmoxInstallationMarkdown } from "../../Pages/Proxmox/Utils/DocumentationMarkdown";
...
const ProxmoxDocumentationCard: FunctionComponent<ComponentProps> = (
      ...
      return (
        <div className="text-center py-6">
          ...
          <p className="text-xs text-gray-500 mb-4">
            Create an ingestion key to authenticate your Proxmox agent.
          </p>
          <button
            type="button"
            onClick={() => {
  ...
  const installationMarkdown: string = getProxmoxInstallationMarkdown({
    ...
    <div>
      ...
      {showCreateModal && (
        <ModelFormModal<TelemetryIngestionKey>
          ...
          description="Create a new telemetry ingestion key for authenticating your Proxmox agent."
          onClose={() => {
            ...
            fields: [
              {
                ...
                required: true,
                placeholder: "e.g. Proxmox Agent Key",
                validation: {
                  minLength: 2,
                },
              },
...
export default ProxmoxDocumentationCard;
