      ...
      <>
        ...
        {showAssignConfirmModal && selectedOwnedNumber ? (
          <ConfirmModal
            ...
            description={`Are you sure you want to use ${selectedOwnedNumber.friendlyName} for this policy? ${selectedOwnedNumber.voiceUrl ? "This number currently has a webhook configured which will be updated to point to Cast Operations." : "The webhook will be configured automatically."}`}
            error={error}
