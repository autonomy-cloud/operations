    ...
    <>
      ...
      {showRegisterDeviceModal ? (
        <BasicFormModal
          ...
          description="This will register your current browser to receive push notifications from Cast Operations. You'll be asked for permission to show notifications."
          isLoading={isLoading}
