...
> = (): ReactElement => {
  ...
  const [containers, setContainers] = useState<Array<PodmanContainerRow>>([]);
  ...
  const fetchData: PromiseVoidFunction = async (): Promise<void> => {
    ...
    setError("");
    try {
      const host: PodmanHost | null = await ModelAPI.getItem({
  ...
  return (
    <Card
      ...
      description="Containers running on this Podman host (last 5 minutes)."
      buttons={cardButtons}
    >
...
export default PodmanHostContainers;
