    ...
    return (
      <Page title={""} breadcrumbLinks={[]}>
        <EmptyState
          ...
          description={
            <>
              Creating new projects is restricted to admin users on this Cast
              Operations Server. Please contact your server admin to be added to
              an existing project.
            </>
          }
        />
  ...
  return (
    <Page title={""} breadcrumbLinks={[]}>
      <EmptyState
        ...
        title={"No projects"}
        description={<>Get started by creating a new project. {false}</>}
        footer={
          <Button
            icon={IconProp.Add}
