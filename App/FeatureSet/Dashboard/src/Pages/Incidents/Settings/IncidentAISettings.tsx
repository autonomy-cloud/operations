    ...
    <>
      <CardModelDetail<Project>
        ...
        cardProps={{
          ...
          description:
            "When enabled, Cast Operations AI automatically investigates every new incident and posts a cited root cause analysis to the incident timeline. Requires an LLM provider to be configured in Settings > AI > LLM Providers.",
        }}
        isEditable={true}
