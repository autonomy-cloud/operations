...
When you react with one of these emojis, Cast Operations will automatically save the message content as a note to the scheduled maintenance event linked to that channel and confirm with a reply in the thread.
              `}
            />
          </Card>
        </>
