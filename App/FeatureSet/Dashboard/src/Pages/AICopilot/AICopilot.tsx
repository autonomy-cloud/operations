  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          height: CAST_OPERATIONS_EMBEDDED_MODE
            ? "calc(100vh - 184px)"
            : "calc(100vh - 220px)",
          minHeight: CAST_OPERATIONS_EMBEDDED_MODE ? "520px" : "560px",
        }}
      >
        {/* Conversation rail */}
        {chat.conversations.length > 0 && (
          <div className="hidden w-[220px] flex-shrink-0 flex-col border-r border-gray-200 bg-gray-50/70 md:flex">
