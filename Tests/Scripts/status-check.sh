...
echo "We would like to hear your feedback to make this product better for you and for other users, please email us at hello@latticeruntime.com."
...
echo "- If you are an enterprise customer, we offer dedicated engineering support to build cast-operations features you need to integrate Cast Operations for your organization. Please contact us at sales@latticeruntime.com"
echo "We would love to hear your feedback. Email: hello@latticeruntime.com"
