...
resource "cast_operations_monitor" "manual_no_steps" {
...
resource "cast_operations_monitor" "manual_with_description" {
...
resource "cast_operations_monitor" "with_interval" {
...
resource "cast_operations_monitor" "disabled" {
