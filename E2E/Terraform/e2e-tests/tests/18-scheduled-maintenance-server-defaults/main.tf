...
resource "cast_operations_scheduled_maintenance_event" "test_server_defaults" {
...
output "scheduled_maintenance_event_id" {
  value       = cast_operations_scheduled_maintenance_event.test_server_defaults.id
...
output "scheduled_maintenance_event_title" {
  value       = cast_operations_scheduled_maintenance_event.test_server_defaults.title
...
output "scheduled_maintenance_event_starts_at" {
  value       = cast_operations_scheduled_maintenance_event.test_server_defaults.starts_at
  description = "Start time of the scheduled maintenance"
}

output "scheduled_maintenance_event_ends_at" {
  value       = cast_operations_scheduled_maintenance_event.test_server_defaults.ends_at
  description = "End time of the scheduled maintenance"
}

# String field - server provides default state
output "current_state_id" {
  value       = cast_operations_scheduled_maintenance_event.test_server_defaults.current_scheduled_maintenance_state_id
  description = "Server-assigned default scheduled maintenance state"
}

# List fields - server may provide empty list or defaults
output "monitors" {
  value       = cast_operations_scheduled_maintenance_event.test_server_defaults.monitors
  description = "Server-provided monitors list"
}

output "labels" {
  value       = cast_operations_scheduled_maintenance_event.test_server_defaults.labels
  description = "Server-provided labels list"
}

output "status_pages" {
  value       = cast_operations_scheduled_maintenance_event.test_server_defaults.status_pages
  description = "Server-provided status pages list"
}

# Bool fields - server provides defaults
output "notify_on_created" {
  value       = cast_operations_scheduled_maintenance_event.test_server_defaults.should_status_page_subscribers_be_notified_on_event_created
  description = "Server-provided default for notification on create"
}

# Other server-computed fields
output "slug" {
  value       = cast_operations_scheduled_maintenance_event.test_server_defaults.slug
  description = "Server-generated slug"
}

output "created_at" {
  value       = cast_operations_scheduled_maintenance_event.test_server_defaults.created_at
