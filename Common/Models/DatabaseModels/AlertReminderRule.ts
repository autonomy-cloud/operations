...
@TableAccessControl({
  ...
  delete: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    Permission.DeleteAlertReminderRule,
  ],
  update: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
...
@TableMetadata({
  tableName: "AlertReminderRule",
  singularName: "Alert Reminder Rule",
  pluralName: "Alert Reminder Rules",
  icon: IconProp.Bell,
  tableDescription:
...
export default class AlertReminderRule extends BaseModel {
  ...
  @TableColumn({
    ...
    description:
      "How often (in minutes) to remind alert owners while the alert is still open. For example, set to 30 to remind owners every 30 minutes.",
    canReadOnRelationQuery: true,
  })
  @Column({
    type: ColumnType.Number,
  ...
  @TableColumn({
    ...
    description:
      "Stop sending reminders once the alert reaches this state. Select Acknowledged to stop reminders when the alert is acknowledged, or Resolved to keep reminding until the alert is resolved.",
  ...
  // Match Criteria - Alert Severities
  ...
  @TableColumn({
    ...
    description:
      "Only apply this reminder rule to alerts with these severities. Leave empty to match alerts of any severity.",
  })
  @ManyToMany(
    () => {
  ...
  @JoinTable({
    name: "AlertReminderRuleAlertSeverity",
    inverseJoinColumn: {
