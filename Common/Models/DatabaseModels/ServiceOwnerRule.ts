...
@TableAccessControl({
  create: [
    ...
    Permission.CreateServiceOwnerRule,
  ],
  read: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.Viewer,
    Permission.ReadServiceOwnerRule,
  ],
  delete: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    Permission.DeleteServiceOwnerRule,
  ],
  update: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    Permission.EditServiceOwnerRule,
  ],
})
@CrudApiEndpoint(new Route("/service-owner-rule"))
@Entity({
  name: "ServiceOwnerRule",
})
@EnableWorkflow({
  create: true,
  delete: true,
...
@TableMetadata({
  tableName: "ServiceOwnerRule",
  singularName: "Service Owner Rule",
  pluralName: "Service Owner Rules",
  icon: IconProp.User,
  tableDescription:
    "Configure rules for automatically assigning owner users and teams when matching services are created",
})
export default class ServiceOwnerRule extends BaseModel {
  @ColumnAccessControl({
    create: [
      Permission.ProjectOwner,
      Permission.ProjectAdmin,
  ...
  @TableColumn({
    ...
    canReadOnRelationQuery: true,
    title: "Name",
    description: "Name of this service owner rule",
  })
  @Column({
    nullable: false,
  ...
  @TableColumn({
    ...
    title: "Description",
    description: "Description of this service owner rule",
  })
  @Column({
    nullable: true,
  ...
  @TableColumn({
    ...
    description:
      "Only trigger for services that have at least one of these labels. Leave empty to match regardless of labels.",
  })
  @ManyToMany(
    () => {
      return Label;
  ...
  @JoinTable({
    name: "ServiceOwnerRuleServiceLabel",
    inverseJoinColumn: {
      name: "labelId",
      referencedColumnName: "_id",
    },
    joinColumn: {
      name: "serviceOwnerRuleId",
      referencedColumnName: "_id",
    },
  })
  ...
  @TableColumn({
    ...
    title: "Owner Users",
    description:
      "Users to add as owners on the service when this rule matches.",
  })
  @ManyToMany(
    () => {
      return User;
  ...
  @JoinTable({
    name: "ServiceOwnerRuleOwnerUser",
    inverseJoinColumn: {
      name: "userId",
      referencedColumnName: "_id",
    },
  ...
  @TableColumn({
    ...
    title: "Owner Teams",
    description:
      "Teams to add as owners on the service when this rule matches.",
  })
  @ManyToMany(
    () => {
      return Team;
  ...
  @JoinTable({
    name: "ServiceOwnerRuleOwnerTeam",
    inverseJoinColumn: {
      name: "teamId",
      referencedColumnName: "_id",
    },
