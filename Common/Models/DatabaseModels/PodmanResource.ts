 ...
 * ------------------------------------------------------------------
 *
 * Inventory snapshot of a single Podman object (Container, Image,
 * Network, Volume) on a single Podman host. Populated by the
...
@CrudApiEndpoint(new Route("/podman-resource"))
@TableMetadata({
  tableName: "PodmanResource",
  singularName: "Podman Resource",
...
export default class PodmanResource extends BaseModel {
  @ColumnAccessControl({
    create: [],
    read: READ_PERMISSIONS,
    update: [],
  ...
  @TableColumn({
    ...
    description: "ID of the Podman Host this resource lives on.",
  })
  @Column({
    type: ColumnType.ObjectID,
    nullable: false,
  ...
  @TableColumn({
    ...
    title: "Kind",
    description:
      "Podman resource kind in singular PascalCase (Container, Image, Network, Volume).",
  })
  @Column({
    nullable: false,
  ...
  @TableColumn({
    ...
    title: "Name",
    description:
      "Podman resource name. Container.name for containers, full image reference for images.",
  })
  @Column({
    nullable: false,
    type: ColumnType.ShortText,
  ...
  @TableColumn({
    ...
    title: "Container ID",
    description:
      "Podman container short id (12 chars). Null for non-Container kinds.",
  })
  @Column({
    nullable: true,
    type: ColumnType.ShortText,
  ...
  @TableColumn({
    ...
    title: "Labels",
    description: "Podman labels attached to this resource.",
  })
  @Column({
    nullable: true,
  ...
  @TableColumn({
    ...
    description: "When this resource was created in Podman.",
  })
  @Column({
    nullable: true,
    type: ColumnType.Date,
