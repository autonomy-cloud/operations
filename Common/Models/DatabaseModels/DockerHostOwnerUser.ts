...
@TableAccessControl({
  create: [
    ...
    Permission.CreateDockerHostOwnerUser,
  ],
  read: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
  ...
  delete: [
    ...
    Permission.SettingsAdmin,
    Permission.SettingsMember,
    Permission.DeleteDockerHostOwnerUser,
  ],
  update: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.SettingsAdmin,
    Permission.SettingsMember,
    Permission.EditDockerHostOwnerUser,
  ],
})
@EnableWorkflow({
  create: true,
...
@CrudApiEndpoint(new Route("/docker-host-owner-user"))
@TableMetadata({
  tableName: "DockerHostOwnerUser",
  singularName: "Docker Host User Owner",
  pluralName: "Docker Host User Owners",
  icon: IconProp.Cube,
  tableDescription: "Add users as owners to your Docker hosts.",
})
@Entity({
  name: "DockerHostOwnerUser",
})
export default class DockerHostOwnerUser extends BaseModel {
  @ColumnAccessControl({
    create: [
      Permission.ProjectOwner,
      Permission.ProjectAdmin,
