...
@TableAccessControl({
  create: [
    ...
    Permission.CreateIncidentEpisodePrivacyRule,
  ],
  read: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    ...
    Permission.ReadIncidentEpisodePrivacyRule,
  ],
  delete: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    Permission.DeleteIncidentEpisodePrivacyRule,
  ],
  update: [
    Permission.ProjectOwner,
    Permission.ProjectAdmin,
    Permission.EditIncidentEpisodePrivacyRule,
  ],
})
@CrudApiEndpoint(new Route("/incident-episode-privacy-rule"))
@Entity({
  name: "IncidentEpisodePrivacyRule",
})
@EnableWorkflow({
  create: true,
  delete: true,
...
@TableMetadata({
  tableName: "IncidentEpisodePrivacyRule",
  singularName: "Incident Episode Privacy Rule",
  pluralName: "Incident Episode Privacy Rules",
  icon: IconProp.Lock,
  tableDescription:
    "Configure rules for automatically marking matching incident episodes as private",
})
export default class IncidentEpisodePrivacyRule extends BaseModel {
  @ColumnAccessControl({
    create: [
      Permission.ProjectOwner,
      Permission.ProjectAdmin,
  ...
  @TableColumn({
    ...
    canReadOnRelationQuery: true,
    title: "Name",
    description: "Name of this incident episode privacy rule",
  })
  @Column({
    nullable: false,
  ...
  @TableColumn({
    ...
    title: "Description",
    description: "Description of this incident episode privacy rule",
  })
  @Column({
    nullable: true,
  ...
  @JoinTable({
    name: "IncidentEpisodePrivacyRuleIncidentSeverity",
    inverseJoinColumn: {
      name: "incidentSeverityId",
      referencedColumnName: "_id",
    },
    joinColumn: {
      name: "incidentEpisodePrivacyRuleId",
      referencedColumnName: "_id",
    },
  })
  ...
  @JoinTable({
    name: "IncidentEpisodePrivacyRuleEpisodeLabel",
    inverseJoinColumn: {
      name: "labelId",
      referencedColumnName: "_id",
    },
