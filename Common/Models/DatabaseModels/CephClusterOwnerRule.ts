...
export default class CephClusterOwnerRule extends BaseModel {
  @ColumnAccessControl({
    create: [
      Permission.ProjectOwner,
      Permission.ProjectAdmin,
  ...
  @TableColumn({
    ...
    description:
      "Only trigger for Ceph clusters that have at least one of these labels. Leave empty to match regardless of labels.",
  })
  @ManyToMany(
    () => {
      return Label;
  ...
  @TableColumn({
    ...
    title: "Owner Users",
    description:
      "Users to add as owners on the Ceph cluster when this rule matches.",
  })
  @ManyToMany(
    () => {
      return User;
  ...
  @TableColumn({
    ...
    title: "Owner Teams",
    description:
      "Teams to add as owners on the Ceph cluster when this rule matches.",
  })
  @ManyToMany(
    () => {
      return Team;
