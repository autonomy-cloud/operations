...
`;
  ...
  public async notifyOwnersWhenNoProbeIsEnabled(data: {
    ...
    for (const owner of owners) {
      ...
      const sms: SMSMessage = {
        message: `This is a message from Cast Operations. Probes for monitor ${monitor.name} is ${enabledStatus}. To unsubscribe from this notification go to User Settings in Cast Operations Dashboard.`,
      };

      const callMessage: CallRequestMessage = {
        data: [
          {
            sayMessage: `This is a message from Cast Operations. Probes for monitor ${monitor.name} is ${enabledStatus}. To unsubscribe from this notification go to User Settings in Cast Operations Dashboard. Good bye.`,
          },
        ],
      };
      ...
      await UserNotificationSettingService.sendUserNotification({
        ...
        pushNotificationMessage:
          PushNotificationUtil.createMonitorProbeStatusNotification({
            title: "Cast Operations: Monitor Probe Status",
  ...
  public async notifyOwnersProbesDisconnected(data: {
    ...
    for (const owner of owners) {
      ...
      const sms: SMSMessage = {
        message: `This is a message from Cast Operations. Probes for monitor ${monitor.name} is ${status}. To unsubscribe from this notification go to User Settings in Cast Operations Dashboard.`,
      };

      const callMessage: CallRequestMessage = {
        data: [
          {
            sayMessage: `This is a message from Cast Operations. New monitor was created ${monitor.name}. To unsubscribe from this notification go to User Settings in Cast Operations Dashboard. Good bye.`,
          },
        ],
      };
