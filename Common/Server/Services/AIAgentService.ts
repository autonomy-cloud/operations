    ...
    for (const user of owners) {
      try {
        ...
        const sms: SMSMessage = {
          message: `This is a message from Cast Operations. AI Agent ${aiAgent.name} is ${connectionStatus}. To unsubscribe from this notification go to User Settings in Cast Operations Dashboard.`,
        };

        const callMessage: CallRequestMessage = {
          data: [
            {
              sayMessage: `This is a message from Cast Operations. AI Agent ${aiAgent.name} is ${connectionStatus}. To unsubscribe from this notification go to User Settings in Cast Operations Dashboard. Good bye.`,
            },
          ],
        };
