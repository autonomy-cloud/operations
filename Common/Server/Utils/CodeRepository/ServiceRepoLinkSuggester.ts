 ...
 * code repositories. Used at RUNTIME as a fallback when stack-trace path
 * resolution can't pin the repository (see StackTraceRepoResolver). Pure
 * functions — no persistence, no LLM — cheap, explainable, unit-testable.
 */
