...
function readConfig(t) {
  ...
  return e.test(s.replace(i, "@").replace(o, "]").replace(r, ""))
...
function globalNavPopup(t) {
  if (
    ...
    !document.querySelector(t).querySelector(".popup")
  ) {
    return;
  }
...
!(function () {
  ...
  function i() {
    (o = document.querySelector('[rel="cookie-notification"]')),
      (r = document.querySelector('[rel="dismiss-cookie-notification"]')) &&
      ...
      $(function () {
        ...
        return (
          (t = function () {
            var t, n;
            return (
              (t = $("form input[name=csrf-token]")),
              t.length > 0
                ? t.attr("value")
                : ((n = $("meta[name=csrf-token]")),
                  n.length > 0 ? n.attr("content") : "")
            );
          }),
...
(Strut.isRetina = window.devicePixelRatio > 1.3),
  ...
  (globalNavDropdowns.prototype.checkCollision = function () {
    ...
    if (!Strut.isMobileViewport)
      if (1 == t.compact) {
        ...
        e.left + e.width / 2 > n / 2 &&
          (t.container.classList.remove("compact"), (t.compact = !1));
      } else {
        var i = t.primaryNavItem.getBoundingClientRect(),
          o = t.secondaryNavItem.getBoundingClientRect();
        i.right > o.left &&
          (t.container.classList.add("compact"), (t.compact = !0));
      }
  }),
    ...
    if (this.activeDropdown !== t) {
        ...
        t.el.classList.remove("active"),
          ...
          t.name == r
            ? (t.el.classList.add("active"),
              ...
              t.content.getAttribute("data-fixed")
                ? t.content.setAttribute("data-fixed", !0)
                : ((t.content.style.width = e + "px"),
                  (t.content.style.height = i + "px")),
              (o = t.content))
            : t.el.classList.add(a);
      });
      var s = 380,
        c = 400,
        d = e / s,
      ...
      (p = Math.round(Math.max(p, 10))),
        ...
        (this.dropdownBackground.style.transform =
          "translateX(" + p + "px) scaleX(" + d + ") scaleY(" + l + ")"),
  ...
  (globalNavPopup.prototype.closeAllPopups = function () {
    for (
      var t = document.getElementsByClassName(this.activeClass), n = 0;
      n < t.length;
      n++
    )
  ...
  Strut.supports.pointerEvents ||
    Strut.load.css("v3/shared/navigation_ie10.html"),
  ...
  (function () {
    ...
    function h() {
      window.siteAnalyticsUtil.analyticsConfigData ||
        (g(),
        (window.siteAnalyticsUtil.debugActive = o),
        (window.siteAnalyticsUtil.emitAction = r),
        (window.siteAnalyticsUtil.emitActionOnce = a),
        (window.siteAnalyticsUtil.emitModal = s),
        (window.siteAnalyticsUtil.emitViewed = c),
        (window.siteAnalyticsUtil.siteAnalyticsConfig = i),
        (window.siteAnalyticsUtil.sendToGoogleAnalytics = y),
        (window.siteAnalyticsUtil.generalAnalyticsConfig = e));
    }
  ...
  (function () {
    function t(t) {
      var e = n(t),
        i = {};
      return (
        e.getAttribute(r) && (i.action = e.getAttribute(r)),
        e.getAttribute(s) && (i.modal = e.getAttribute(s)),
        e.getAttribute(a) &&
          (i.params = {
            source: e.getAttribute(a),
          }),
        e.getAttribute(c) &&
          (i.googleAnalyticsParams = JSON.parse(e.getAttribute(c))),
        i
      );
    }

    function n(t) {
      return t.getAttribute(r) || t.getAttribute(s)
        ? t
        : t.parentNode && "BODY" !== t.tagName
          ? n(t.parentNode)
          : null;
    }
    ...
    function i(n) {
      var e = t(n);
      e.modal && window.siteAnalyticsUtil.emitModal(e.modal, e.params),
        e.action && window.siteAnalyticsUtil.emitAction(e.action, e.params),
        e.googleAnalyticsParams &&
    ...
    function o() {
      (window.siteAnalytics.hasAnalyticsAttributes = e),
        (window.siteAnalytics.trackByAttributes = i);
    }
  ...
  (function () {
    function t(t) {
      i[t] ||
        ((i[t] = !0),
        window.siteAnalyticsUtil.emitAction(e, {
          dropdown: t,
        }));
    }
  ...
  (function () {
    ...
    function e(t) {
      ...
      f[n] ||
        ((f[n] = !0),
        window.siteAnalyticsUtil.emitAction(l, {
          text: n,
        }));
    }
    ...
    function i(t) {
      ...
      g[n] ||
        ((f[n] = !0),
        window.siteAnalyticsUtil.emitAction(u, {
          text: n,
        }));
    }
  ...
  (function () {
    ...
    function e(t) {
      ...
      return /\.pdf$|\.pdf#|\.pdf\?/i.test(t.href)
        ? d
        : -1 !== n.indexOf("button") || "#" === e
          ? c
          : s;
    }
    ...
    function r(n) {
      if (window.siteAnalytics.hasAnalyticsAttributes(n.target))
        return void window.siteAnalytics.trackByAttributes(n.target);
      var e = o(n.target);
      e && t(e) && i(e);
    }
  ...
  (function () {
    ...
    function n() {
      return (
        ...
        !!window.siteAnalyticsUtil.siteAnalyticsConfig().trackPageViewed
      );
    }
  ...
  (function () {
    ...
    function c() {
      document.addEventListener("play", a, !0),
        document.addEventListener("ended", s, !0),
        (window.siteAnalytics.trackVideoExpand = t),
        (window.siteAnalytics.trackVideoPlay = n),
        (window.siteAnalytics.trackVideoEnd = e);
    }
    var d = "video_expand",
      l = "video_end",
      u = "video_play";
